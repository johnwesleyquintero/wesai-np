...
export const GripVerticalIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5" {...props}>
      ...
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 10.5h.008v.008H12v-.008zm0 3h.008v.008H12v-.008zm0 3h.008v.008H12v-.008zm-3-6h.008v.008H9v-.008zm0 3h.008v.008H9v-.008zm0 3h.008v.008H9v-.008zm-3-6h.008v.008H6v-.008zm0 3h.008v.008H6v-.008zm0 3h.008v.008H6v-.008z" transform="rotate(-45 12 12)" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M9 5.25l.75 7.5-7.5.75" transform="rotate(-90 12 12)" />
    </svg>
)
...
export const StrategyIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="w-6 h-6" {...props}>
        <path d="M2 16.22C2 17.77 3.23 19 4.78 19h.44c1.55 0 2.78-1.23 2.78-2.78v-1.44c0-1.55-1.23-2.78-2.78-2.78h-.44C3.23 12 2 13.23 2 14.78v1.44z"/>
        <path d="M15 12a5 5 0 0 0-10 0"/>
        <path d="M22 12a10 10 0 0 0-15-8.66"/>
        <path d="M22 12h-4"/>
        <path d="M4.78 19L9 12"/>
        <path d="M9 12l.33-1.31a4 4 0 0 1 1.35-2.33L12 7l1.67 1.36a4 4 0 0 1 1.35 2.33L15 12"/>
    </svg>
)

export const StarIcon: React.FC<IconProps> = ({ filled, ...props }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill={filled ? 'currentColor' : 'none'} strokeWidth={1.5} stroke="currentColor" className="w-5 h-5" {...props}>
