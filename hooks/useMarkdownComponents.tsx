...
import { InformationCircleIcon, LightBulbIcon, ExclamationTriangleIcon, ExclamationCircleIcon } from '../components/Icons';
import CodeBlockWithCopy from '../components/markdown/CodeBlockWithCopy';
...
export const useMarkdownComponents = ({ onToggleTask }: UseMarkdownComponentsProps) => {
    ...
    }), [getNoteById, onToggleTask, setActiveNoteId, setView]);
};
