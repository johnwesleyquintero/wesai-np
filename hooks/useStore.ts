...
import { fromSupabase, toSupabase, processNote } from '../lib/supabaseUtils';
...
export const useStore = (user: User | undefined) => {
    ...
    // Use extracted hook for realtime updates
    useRealtimeSubscriptions(user, setNotes, setCollections, setSmartCollections, setTemplates);
